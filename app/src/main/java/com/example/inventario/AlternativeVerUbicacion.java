...
public class AlternativeVerUbicacion extends AppCompatActivity {
        ...
        StringRequest sr = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    if (AlternativeVerUbicacion.this.pd != null) {
                        AlternativeVerUbicacion.this.pd.dismiss();
                    }
                    e.printStackTrace();
    ...
    public void cargarImagenes(ArrayList<String>[] matriz) {
        new AlternativeVerUbicacion.GetItemImages().execute(matriz);
    }
    ...
    class GetItemImages extends AsyncTask<ArrayList<String>[], Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap feed) {
            ...
            if(exception==null){
                ...
                Toast.makeText(AlternativeVerUbicacion.this, "Some pictures weren't found", Toast.LENGTH_LONG).show();
                adaptadorInfoImagen(matrizea, lasimagenes);
            }
        }
    }
